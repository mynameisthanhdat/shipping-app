...
export const OUR_SERVICES_CONTENT: {
  ...
  hub: {
    ...
    introduction:
      'Bee Direct has become known as one of the leading couriers in Australia due to our provision of a comprehensive range of services. We understand that everyone has different needs when it comes to ensuring their packages are safely delivered, and as such offer a number of options to match.',
    ...
    serviceItems: [
      {
        ...
        description:
          'Bee Direct’s network Carriers are the leading providers of Express Road Freight Services. With the Domestic ability to access All Capitals, Major Regionals, and Remote locations, Nationwide.',
      },
      {
        title: 'Nationwide Road Economy',
        description:
          'Take advantage of Bee Direct’s network Carriers cost effective Nationwide Road Economy B2B, B2C and C2C Freight Services. These offer the delivery reach of our Nationwide Road Express Services, at a reduced cost.',
      },
      {
        title: 'Australia wide Same Day and Overnight Airfreight Services',
        description:
          'These are Bee Direct’s network Carriers Priority suite of time specific B2B, B2C and C2C, Same day, Overnight services. These offer the Domestic ability to access All Capitals, Major Regionals, and Remote locations, Nationwide.',
      },
      {
        title: 'Same day local 1,2 and 4 hour delivery services within the same capital city',
        description:
          'Bee Direct offers a Direct drive within the hour, a 1-2 hour, and a 3-4 hour delivery, after the advised collection time. This service is available within Metropolitan Melbourne, Sydney, Brisbane, Perth and Adelaide.',
      },
      {
    ...
    closingText:
      'Contact Bee Direct today to learn more about our services and how we are able to assist you.',
  },
  interstate: {
    ...
    introduction: {
      ...
      paragraphs: [
        'Deliveries that span across Australian states and territories can often be more complex and have the potential for more error to occur, which is why you need an interstate courier you can trust. Bee Direct has a wealth of knowledge providing a wide range of services to suit every individual, family and business. Some of the reasons we are known as the best in our field include our high priority and fast delivery options, our fragile items policy, our punctual and polite couriers and our safe transport and delivery procedures.',
      ],
    },
    trust: {
      heading: 'Trusted by 100,000 business',
      paragraphs: [
        'People use the Bee Direct interstate courier services for a variety of reasons. Most value our exceptional customer service and have grown to truly trust us. We aim to instill confidence in every one of our clients, every time we work with them, because we want to make life a little bit easier and never more difficult.',
        'Some are simply after a cheap, safe, quick and reliable courier that will save them a trip to the post office. Others are in a hurry to get something from point A to point B and know that we can deliver in a short time frames. Whether your delivery needs are big or small, your items heavy or light, you’ve booked us at the last minute or months in advance – Bee Direct is the best interstate courier company for the job.',
      ],
    },
    shipping: {
    ...
    moreInformation: {
      label: 'More on Bee Direct’s interstate services',
      paragraphs: [
        'Bee Direct is the leader when it comes to interstate freight companies because we have the wealth of experience with freight transport Australia wide that our customers have grown to trust.',
        ...
        'We guarantee a reliable and smooth process superior to interstate freight services that other Australian interstate transport companies currently offer. Bee Direct makes sure your precious interstate freight reaches its destination with ease and the most affordable pricing to suit your needs.',
        ...
        'Bee Direct knows through years of experience that customers feel more secure knowing where their freight is and how long it will take to be delivered. Bee Direct definitely meets the needs of all customers across the country with a very efficient, cost effective and seamless process.',
        'We address the needs of our customers from large business, small business, families and individuals. Those after cheap interstate couriers wanting items delivered safely and in a very timely fashion use Bee Direct.',
        'Customers needing deliveries for those emergency situations can select from our range of Express services. Large companies needing freight with more individual and specialty requirements in the shipping process rely on Bee Direct.',
        'Whether you require freight shipped by air, land or sea. Planes, trucks, vans, cars, motorbikes, bicycles or on foot. Cargo ships, boats, or small sea faring craft. Same day Delivery, Overnight delivery. Next day delivery. Express delivery. Specialty delivery. Large and small items delivered anywhere within Australia. Bee Direct’s vast network offers all of the transport services to suit your budget and specific needs and requirements.',
  ...
  sameDay: {
    ...
    introduction: [
      'Need something delivered urgently? Bee Direct’s same-day courier service helps both individuals and businesses send parcels fast, with delivery arranged the same day the booking is made*. It doesn’t matter if you’re a busy ecommerce seller, a small business juggling fast-moving stock or simply need a personal package sent straight away, we’ve got you covered.',
    ...
    whyChooseHeading: 'Why Choose Bee Direct for Same-Day Delivery?',
    compareCouriers: {
    ...
    australiaWide: {
      ...
      paragraphs: [
        'Our same-day courier services operate across major metropolitan areas right around the country. Whether you’re located in a CBD or surrounding suburbs, Bee Direct connects you to fast, local couriers.',
      ],
    ...
    competitiveRates: {
      ...
      paragraphs: [
        'Bee Direct helps you compare and save by showing discounted rates across multiple courier partners. There’s no need to contact couriers individually – our instant quotes do the heavy lifting for you.',
      ],
    },
    bookingProcess: {
  ...
  nextDay: {
    ...
    introduction: {
      ...
      prefix: 'Welcome to Bee Direct. Let our',
    ...
    savings: {
      ...
      parcelPost: {
        prefix:
          'With Bee Direct, you’ll enjoy rates 10% below standard overnight delivery costs for',
      ...
      memberDiscount: {
        ...
        linkLabel: 'our exclusive Bee Direct Member discounts',
        suffix: 'you’ll easily save 30% on next-day courier costs!',
      },
      finalParagraph:
        'Even without a free Bee Direct Member account, you can get a free instant quote, book the best next-day delivery courier for your needs, and track your package from pickup to drop-off, across Australia.',
    },
    quotes: {
  ...
  parcelDelivery: {
    ...
    lead:
      'When you need a parcel delivered within Australia, trust Bee Direct for the cheapest, fastest couriers available.',
    courierNetwork: {
      prefix: 'By partnering with Australia’s leading',
      linkLabel: 'courier network',
      suffix:
        'our Bee Direct members enjoy the biggest savings compared to standard parcel post delivery rates.',
    },
    savings: {
      ...
      membership: {
        prefix:
          'The more you send, the more you save, so if you ship a high volume of parcels with us as a Bee Direct member, you’ll easily see savings of 30%.',
        linkLabel: 'Becoming a Bee Direct member is free',
        suffix:
    ...
    quote: {
      ...
      linkLabel: 'Bee Direct Quote tool',
      suffix:
  ...
  palletTransport: {
    ...
    paragraphs: [
      {
        text: 'Bee Direct offers the state of the art pallet delivery service Australians need when pallet transport is required for freight. Shipping pallets provide safety for larger loads, adding strength and stability when you’re shipping freight.',
      },
      {
        text: 'Bee Direct specialises in pallet shipping. We are the experts in palletised road transport from regional areas and across all of our capital cities. Our experienced team of professionals and our excellent freight booking system ensures when our customers need a pallet courier that we are the best.',
        highlightedText: 'Bee Direct',
      },
      {
      ...
      {
        text: 'Note that you’ll need to pack your goods correctly before pallet delivery, to avoid extra costs or fees for incorrect weights and dimensions. From your pallet delivery quote Bee Direct guarantees a smooth and easy process from the beginning to the very end. Bee Direct ensures your goods are delivered safely, securely and on time. Using our pallet freight services gives you peace of mind when larger freight is required to be shipped interstate and to all corners of Australia.',
      ...
      {
        text: 'At Bee Direct, we continually invest in transport options, delivery services and shipping technology to provide the most affordable courier services for our valued customers.',
      },
      {
        text: 'Bee Direct’s years of transport excellence ensure you get the best pallet and freight delivery services in Australia and beyond. When shipping your precious cargo, interstate or to all corners of our great nation, trust Bee Direct couriers for the highest level of service at the lowest rates.',
      },
    ],
  },
  carbonNeutral: {
    ...
    sections: [
      {
        ...
        paragraphs: [
          {
            text: 'In 2019, Bee Direct became one of Australia’s first certified carbon neutral delivery couriers. Even five years later, we’re among the few carbon neutral shipping services to offer customers this benefit.',
          ...
          {
            text: 'From small parcels to large pallets, whichever Bee Direct carbon neutral delivery partners you ship with, you’ll automatically be doing your part to help offset carbon emissions.',
            highlightedText: 'Bee Direct carbon neutral delivery partners',
          },
        ],
      },
      {
        ...
        paragraphs: [
          {
            text: 'To become carbon neutral, Bee Direct partnered with the Carbon Reduction Institute. Our target was and is to offset 100% of the emissions of our freight services.',
            highlightedText: 'Carbon Reduction Institute',
          },
          {
