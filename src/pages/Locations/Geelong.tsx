...
import GeelongLocationContent from '../../components/Locations/GeelongLocationContent';
...
/**
 * City landing for Geelong: quote step 1 entry + city marketing copy.
 * Submitting hands package details into Get a Quote at step 2.
 */
const Geelong: React.FC = () => {
  ...
  return (
    <article className="mx-auto w-full max-w-container px-6 pb-24 pt-8 text-navy">
      <nav aria-label="Breadcrumb" className="text-sm text-muted">
        ...
        <span> / Couriers in Geelong, VIC</span>
      </nav>
