...
import HobartLocationContent from '../../components/Locations/HobartLocationContent';
...
/**
 * City landing for Hobart: quote step 1 entry + city marketing copy.
 * Submitting hands package details into Get a Quote at step 2.
 */
const Hobart: React.FC = () => {
  ...
  return (
    <article className="mx-auto w-full max-w-container px-6 pb-24 pt-8 text-navy">
      <nav aria-label="Breadcrumb" className="text-sm text-muted">
        ...
        <span> / Courier Services in Hobart, Tasmania</span>
      </nav>
