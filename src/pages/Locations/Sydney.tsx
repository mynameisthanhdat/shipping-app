...
import SydneyLocationContent from '../../components/Locations/SydneyLocationContent';
import { PATHS } from '../../routes/paths';
import { QUOTE_STEPS, getQuoteStepPath } from '../../routes/quoteSteps';
import { PackageDetails } from '../../types/quote';

/**
 * City landing for Sydney: quote step 1 entry + city marketing copy.
  ...
  return (
    <article className="mx-auto w-full max-w-container px-6 pb-24 pt-8 text-navy">
      <nav aria-label="Breadcrumb" className="text-sm text-muted">
        ...
        <span> / Courier Services in Sydney, NSW</span>
      </nav>
