...
import BrisbaneLocationContent from '../../components/Locations/BrisbaneLocationContent';
...
/**
 * City landing for Brisbane: quote step 1 entry + city marketing copy.
  ...
  return (
    <article className="mx-auto w-full max-w-container px-6 pb-24 pt-8 text-navy">
      <nav aria-label="Breadcrumb" className="text-sm text-muted">
        ...
        <span> / Couriers in Brisbane, QLD</span>
      </nav>
