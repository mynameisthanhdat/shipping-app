...
import CanberraLocationContent from '../../components/Locations/CanberraLocationContent';
...
/**
 * City landing for Canberra: quote step 1 entry + city marketing copy.
  ...
  return (
    <article className="mx-auto w-full max-w-container px-6 pb-24 pt-8 text-navy">
      <nav aria-label="Breadcrumb" className="text-sm text-muted">
        ...
        <span> / Canberra Couriers, Freight &amp; Delivery</span>
      </nav>
