...
const HEAD_CELL = 'whitespace-nowrap px-3 py-2.5 text-left text-sm font-normal text-ink';
const BODY_CELL = 'px-3 py-3 text-left text-sm text-ink';
...
const CarrierQuoteTable: React.FC<CarrierQuoteTableProps> = ({
  ...
  <div className="overflow-x-auto border-t border-black/10 pt-4">
    <table className="w-full min-w-[960px] border-collapse">
      <caption className="mb-2 text-left text-base font-bold text-ink">
          ...
          >
            ...
            <td className={BODY_CELL}>
              <button
                ...
                className="whitespace-nowrap rounded-md bg-brand px-4 py-1.5 text-sm font-bold uppercase tracking-wider text-ink transition-colors hover:bg-brand-hover"
              >
                Book Now
              </button>
            </td>
