...
const HomeTestimonialGrid: React.FC = () => (
  <section>
    <h2 className="text-2xl font-bold text-ink">Trusted by Businesses Everywhere</h2>
    ...
    <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {HOME_TESTIMONIALS.map((item) => (
        ...
        >
          <p className="flex-1 text-sm leading-relaxed text-ink">&ldquo;{item.quote}&rdquo;</p>
